        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl md:shadow-2xl text-center">
            ...
            <button
              ...
              className="mt-6 md:mt-24 bg-[#33B77E] text-white px-8 md:px-12 py-4 md:py-6 rounded-full text-lg md:text-2xl font-bold flex items-center justify-center gap-3 md:gap-4 mx-auto
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl md:shadow-2xl text-center">
            ...
            <button
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#33B77E] text-white px-8 md:px-12 py-4 md:py-6 rounded-full text-lg md:text-2xl font-bold flex items-center justify-center gap-3 md:gap-4 mx-auto
              transition-all duration-300 hover:bg-[#2a9a6a] hover:scale-[1.03]"
            >
              <img
                src="https://cdn-icons-png.flaticon.com/512/733/733585.png"
